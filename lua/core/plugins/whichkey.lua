...
local nmappings = {
	...
	c = {
		...
		x = { "<cmd>TroubleToggle document_diagnostics<CR>", "Trouble Toggle document_diagnostics" },
		...
		s = { "<cmd>TroubleToggle lsp_type_definitions<CR>", "Toggle lsp type definitions" },
	},
	b = {
		name = "Buffers",
